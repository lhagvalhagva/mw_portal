...
const POPOVER_CLASS = "z-[100] bg-white dark:bg-slate-950 opacity-100 shadow-xl border border-border p-0"
        ...
        case "selection":
            return (
                <Select value={value || ""} onValueChange={onChange}>
                    ...
                    <SelectContent className={POPOVER_CLASS}>
                        {options?.map((opt) => (
        ...
        case "time":
            return (
                <div className="relative group w-full">
                    <div className={cn("flex items-center border rounded-md relative overflow-hidden", inputClass)}>
            ...
            return (
                <Popover>
                    <PopoverTrigger asChild>
                        <Button variant="outline" className={cn("justify-start text-left font-normal px-2", inputClass, !value && "text-muted-foreground")}>
